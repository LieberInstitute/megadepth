---
title: "Loading coverage using megadepth vs pyBigWig vs rtracklayer"
...
- As `pyBigWig` is a python package, here I will use `reticulate` to run a 
...
comp_time_plot <- 
  ggplot2::ggplot(comp_time, ggplot2::aes(x = tool, y = run_time, colour = local_remote)) + 
  ggplot2::geom_violin() +  
  ggplot2::theme_bw() 
